...
export var DocumentAdd = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
    ...
    return (React.createElement(StyledIconBase, tslib_1.__assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 24 24" }, props, { ref: ref }),
        React.createElement("path", { d: "M15 12h-2v-2a1 1 0 10-2 0v2H9a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2zm4.707-4.707l-4-4A.996.996 0 0015 3H7C5.346 3 4 4.346 4 6v12c0 1.654 1.346 3 3 3h10c1.654 0 3-1.346 3-3V8a.996.996 0 00-.293-.707zM17.586 8H16.5c-.827 0-1.5-.673-1.5-1.5V5.414L17.586 8zM17 19H7a1 1 0 01-1-1V6a1 1 0 011-1h7v1.5C14 7.879 15.121 9 16.5 9H18v9a1 1 0 01-1 1z", key: "k0" })));
});
DocumentAdd.displayName = 'DocumentAdd';
export var DocumentAddDimensions = { height: 24, width: 24 };
