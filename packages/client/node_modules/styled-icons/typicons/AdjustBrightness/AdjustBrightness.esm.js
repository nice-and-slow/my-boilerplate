...
export var AdjustBrightness = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
AdjustBrightness.displayName = 'AdjustBrightness';
export var AdjustBrightnessDimensions = { height: 24, width: 24 };
