...
export var WeatherCloudy = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
WeatherCloudy.displayName = 'WeatherCloudy';
export var WeatherCloudyDimensions = { height: 24, width: 24 };
