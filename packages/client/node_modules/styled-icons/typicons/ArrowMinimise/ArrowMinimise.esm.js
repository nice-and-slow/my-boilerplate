...
export var ArrowMinimise = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
ArrowMinimise.displayName = 'ArrowMinimise';
export var ArrowMinimiseDimensions = { height: 24, width: 24 };
