...
export var UserDeleteOutline = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
...
UserDeleteOutline.displayName = 'UserDeleteOutline';
export var UserDeleteOutlineDimensions = { height: 24, width: 24 };
