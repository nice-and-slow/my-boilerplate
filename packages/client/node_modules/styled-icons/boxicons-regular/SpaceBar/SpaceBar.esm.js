...
export var SpaceBar = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
    ...
    return (React.createElement(StyledIconBase, tslib_1.__assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 24 24" }, props, { ref: ref }),
        React.createElement("path", { d: "M17 13H7V9H5v6h14V9h-2z", key: "k0" })));
});
SpaceBar.displayName = 'SpaceBar';
export var SpaceBarDimensions = { height: 24, width: 24 };
