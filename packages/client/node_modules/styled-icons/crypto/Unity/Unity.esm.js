...
export var Unity = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
    ...
    return (React.createElement(StyledIconBase, tslib_1.__assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 32 32" }, props, { ref: ref }),
        React.createElement("g", { fillRule: "evenodd", key: "k0" },
            ...
            React.createElement("path", { fillRule: "nonzero", d: "M25.912 18.875v-5.854c.657.889 1.024 1.882 1.024 2.927 0 1.046-.367 2.037-1.024 2.927zm-1.649-7.46l.005 7.461c-2.343-3.326-5.844-7.511-10.147-8.909a10.616 10.616 0 00-2.293-.477A16.87 16.87 0 0115.905 9c3.34 0 6.335.936 8.358 2.415z", opacity: .5 }))));
});
Unity.displayName = 'Unity';
export var UnityDimensions = { height: 32, width: 32 };
