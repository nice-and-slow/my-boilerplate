...
export var Dtr = React.forwardRef(function (props, ref) {
    var attrs = {
        "fill": "currentColor",
    ...
    return (React.createElement(StyledIconBase, tslib_1.__assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 32 32" }, props, { ref: ref }),
        React.createElement("g", { fillRule: "evenodd", key: "k0" },
            ...
            React.createElement("path", { fillRule: "nonzero", d: "M24.956 17.4c0 1.145-.92 2.074-2.056 2.074s-2.056-.93-2.056-2.075v-5.233c0-1.146.92-2.075 2.056-2.075s2.056.929 2.056 2.075z", opacity: .5 }))));
});
Dtr.displayName = 'Dtr';
export var DtrDimensions = { height: 32, width: 32 };
