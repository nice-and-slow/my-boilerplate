...
export var ArrowUpCircle = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(StyledIconBase, tslib_1.__assign({ iconAttrs: attrs, iconVerticalAlign: "middle", iconViewBox: "0 0 24 24" }, props, { ref: ref }),
        ...
        React.createElement("polyline", { points: "16 12 12 8 8 12", key: "k1" }),
        React.createElement("line", { x1: 12, x2: 12, y1: 16, y2: 8, key: "k2" })));
});
ArrowUpCircle.displayName = 'ArrowUpCircle';
export var ArrowUpCircleDimensions = { height: 24, width: 24 };
